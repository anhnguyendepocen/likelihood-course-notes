...
def propose_parameter(old_p, bounds, window_width=1.0):
...
def do_mcmc(data, num_iterations, param_output_stream, initial_point):
    ...
    for iteration in xrange(num_iterations):
        ...
        params_as_str_list = [str(i) for i in curr_p]
...
if __name__ == '__main__':
    ...
    print "Ran " + str(num_iterations) + " iterations over all " + len(curr_params) + " parameters.\n"
